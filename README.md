...
Agent skills for the [Obsidian Social Archiver](https://github.com/hyungyunlim/obsidian-social-archiver-releases) plugin. Lets Claude Code, Codex CLI, and any other [Claude Skills](https://code.claude.com/docs/en/skills)-compatible agent drive the Obsidian CLI or edit vault Markdown directly to archive social-media posts, post vault notes to the timeline, add comments to archived posts, poll jobs, manage tags, run subscriptions sync, and import Instagram Saved exports — without opening modals or relying on UI state.

Requires the [Obsidian Social Archiver plugin](https://github.com/hyungyunlim/obsidian-social-archiver-releases) (v3.6.2+) installed and enabled in an Obsidian vault, and Obsidian 1.12.2+ with CLI enabled (Settings → General → Command line interface).
...
**Claude Code** — copy the repo contents into the `.claude` folder at your Obsidian vault root (or a project root) per the [Claude Skills docs](https://code.claude.com/docs/en/skills):
...
| Skill | Function |
|---|---|
| [`obsidian-social-archiver-cli`](./skills/obsidian-social-archiver-cli/SKILL.md) | Operate the Obsidian Social Archiver plugin through `obsidian` CLI or direct vault Markdown — archive URLs, ingest selected TweetClaw/X source packs, post vault notes to the timeline, generate/list AI comments, edit personal notes, poll jobs, list/apply tags, run subscriptions sync, import Instagram exports. |
